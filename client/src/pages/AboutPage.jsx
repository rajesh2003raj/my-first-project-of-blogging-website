...
export default function AboutPage() {
  return (
    <div className=" min-h-screen text-3xl gap-3 ml-20">
    <h1 className=" text-xl md:text-3xl text-center p-4  "> hey I'm full-Stack web Developer!</h1>
     ...
     <li className=" ml-6"> <span className=" text-xl"> express:</span> A good knowledge  of express  </li>  
